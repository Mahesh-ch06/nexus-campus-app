...
-- First, drop the existing function and all dependent triggers
...
-- Also improve the role assignment function
DROP FUNCTION IF EXISTS public.assign_default_role_on_signup() CASCADE;
