...
export interface Engagement {
    ...
    badges: Record<string, unknown> | null; // JSONB
...
export interface Preferences {
    ...
    widgets_enabled: Record<string, unknown> | null; // JSONB
}
...
export const getUserProfile = async (supabaseUid: string): Promise<UserProfile | null> => {
  try {
    ...
    // First try a simple query without joins to see if basic connectivity works
    console.log("Step 1: Testing basic user query...");
    ...
    console.log("Basic query result:", { hasError: !!basicError, hasData: !!basicData });
    ...
    if (!basicData) {
      console.log("No user found with UID:", supabaseUid);
      return null;
    }

    console.log("Step 2: User found, now fetching related data...");
    ...
    console.log("Full query completed:", { hasError: !!error, hasData: !!data });
