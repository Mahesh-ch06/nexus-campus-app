...
import { 
  ...
  Settings, LogOut, Bell, Clock, Zap, Menu, X, Package, Trophy, UserCog, IdCard, RotateCcw, CheckCircle
} from "lucide-react";
...
function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* Welcome message for authenticated users with profiles */}
      {user && profile && (
      ...
      {/* ChatBot Component */}
      <ChatBot userProfile={profile || undefined} />
    </div>
  );
}
